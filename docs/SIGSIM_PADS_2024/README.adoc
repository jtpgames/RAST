...
|C1
|Table 3
|Create Predictive Model and look at the folder `Regression-Analysis_Workload-Characterization/regression_analysis_results`. The R² score is part of the folder name of the created model, e.g., DT_**r2-0.966**_24-05-2024_16:04:06
...
|C5
|Table 2
| Perform Full Experiment. The ResultComparer script creates a requests_count.txt file containing the number of requests found in the prediction and validation data.
