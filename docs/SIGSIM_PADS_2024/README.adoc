...
== Article Claims
The article has the following major claims:
...
and the following minor claims:
...
The mapping between claims, experiments, figures and tables are as follows (figures and tables are located in `docs/SIGSIM_PADS_2024/Artefact Submission`:

|===
|Claim |Figures / Tables |Experiment

|C1
|Table 3
|Create Predictive Model and look at the folder `Regression-Analysis_Workload-Characterization/regression_analysis_results`. The R² score is part of the folder name of the created model, e.g., DT_**r2-0.4028_**09-12-2023_13:42:30
...
| Perform Full Experiment and compare the respective figure pairs.

|C4
| Fig. 8, 9 or Fig. 10, 11, and Tables 4, 5
| Perform Full Experiment and compare the respective figure pairs and tables.

|C5
|Table 2
|Create Prediction and Validation Data and count the number of received requests in the respective dataset.
|===
