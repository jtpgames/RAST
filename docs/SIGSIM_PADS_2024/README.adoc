...
For the results uploaded to this repository, we set `LOAD_SCALING_FACTOR = 7.0`.
...
[source,sh]
----
wget https://zenodo.org/records/12740635/files/RAST.zip?download=1
----

[NOTE]
The id in the URL refers to the specific version of the artefact. Make sure that you use the latest version found in the Zenodo repository because the version given in the command here will likely be outdated.
